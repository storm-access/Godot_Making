...
func _ColorChange(Index,Text):
	if SkillList.ColorSet[Index] == "equal":
		...
		Text.modulate = Color8(256,256,256,256)
	if SkillList.ColorSet[Index] == "plus":
		Text.modulate = Color8(0,128,256,256)
	if SkillList.ColorSet[Index] == "minus":
		Text.modulate = Color8(256,0,0,256)



func _on_get_skill_1_button_up():
